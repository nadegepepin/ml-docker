...
--processing-inputs '[ {   "InputName": "input",   "S3Input": { "S3Uri": "s3://sagemaker-studio-3fqzdvw0h4y/capstone-prototype/data/rawdata", "LocalPath": "/opt/ml/processing/data/rawdata", "S3DataType": "S3Prefix", "S3InputMode": "File", "S3DataDistributionType": "FullyReplicated", "S3CompressionType": "None"   } }  ]' \
